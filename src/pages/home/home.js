          ...
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div className="box">
              <div className="box-head">
                <h3 className="box-title">Latest Product</h3>
                      ...
                      <div className="product-block">
                        ...
                        <div className="product-content">
                          ...
                          <div className="product-meta">
                            ...
                            <a href="#" className="discount-price">
                              $1400
                            </a>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="feature-left">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Prasent orci dolor, pretium vitae hendrerit convallisutes
                    orcgravida bibendum.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="feature-left">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Aliqum molestie uraased one pharetra vestibulum Interdum et
                    malesuada fames.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="feature-left">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Vivamus semper nisbesbla accumsan dui justo esw finibus
                    turpis serom
                  </p>
                </div>
              </div>
